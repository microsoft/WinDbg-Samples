...
ExtCommandDesc::ParseArgDesc(void)
{
    ...
    ArgDesc Args[ExtExtension::s_MaxArgs] = {0};
    ArgDesc* Arg = Args - 1;
                         ...
                         _Out_opt_ PULONG Out32)
{
    ...
    if (StrBuffer)
    {
        memcpy(StrBuffer, (PBYTE)ExtData + ExtData->StrBufferIndex, (StrBufferChars - 1) * sizeof(*StrBuffer));

        StrBuffer[StrBufferChars - 1] = '\0';
    }
